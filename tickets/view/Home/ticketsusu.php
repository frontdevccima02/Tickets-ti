...
<body>
    ...
    <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#insert">
        nuevo ticket
    </button>
    </div>
    <!-- Modal -->
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tbody>
                ...
                <?php
                        $sel="SELECT id_ticket,descripcion,url,agente,mesa,t_registro,estado FROM tickets WHERE usuario = '$usuario'";
                        $res=mysqli_query($conexion,$sel);
                        while($mos=mysqli_fetch_row($res)){?>
                    <tr class=""></tr>
                    <td><?php echo $mos['0']; ?></td>
                    <td><?php echo $mos['1']; ?></td>
                    <td> <a href=" <?php echo $mos['2'] ?> " download class="file">File </a> </td>
