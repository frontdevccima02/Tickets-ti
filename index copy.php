        ...
        <div class="contenedor">
            ...
            <div class="input-contenedor">
                ...
                <input type="password" id="pass" name="password" placeholder="Password">
                 <i class="fa-solid fa-eye icono" id="icono"></i>
            </div>
            ...
            <p>Â¿No tienes cuenta?<a class="link" href="./php/registrou.php">Registrate</a></p>
            <p>¢ÄOlvidaste tu contrase«Ğa?<a class="link" href="./rpassword.php">Recuperala</a></p>
        </div>
    </form>
