          ...
          <table class="table">
            <tbody>
              <tr class="">
                ...
                <td><div class="mb-3">
                  <input type="text"
                    class="form-control" name="" id="txtId" aria-describedby="helpId" placeholder="">
                </div></td>
              </tr>
              <tr class="">
                <td>Fecha:</td>
                <td><div class="mb-3">
                  <input type="text"
                    class="form-control" name="" id="txtFecha" aria-describedby="helpId" placeholder="">
                </div></td>
              </tr>
              <tr class="">
                <td>Nombre:</td>
              ...
              <tr class="">
                ...
                <td><div class="mb-3">
                  <input type="text"
                    class="form-control" name="" id="txtHora" aria-describedby="helpId" placeholder="" value="09:00">
                </div></td>
              </tr>
              <tr class="">
                <td>Notas:</td>
